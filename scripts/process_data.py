...
from utils.general import load_image, load_point_cloud, load_video, augment_2d, augment_3d
...
def parse_args():
    ...
    parser.add_argument('--mode', type=str, choices=['2d', '3d', 'video'], required=True, help='Processing mode')
